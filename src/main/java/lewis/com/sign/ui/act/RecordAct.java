...
public class RecordAct extends BaseActivity{
    ...
    public void initView() {
        ...
        //给列表绑定adapter并渲染数据
        adapter = new SimpleAdapter<KechengList.DataBean>(R.layout.item_kc1, beanList, new SimpleAdapter.ConVert<KechengList.DataBean>() {
            @Override
            public void convert(final BaseViewHolder helper, final KechengList.DataBean dataBean) {
                ...
                helper.setText(R.id.tv_ewm,"签到情况");
                //helper.setText(R.id.tv_ewm,"课程二维码");
